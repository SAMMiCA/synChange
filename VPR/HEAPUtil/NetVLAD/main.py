...
import netvlad
from dataset1 import get_whole_val_set
...
parser.add_argument('--root_dir', type=str, default='', help='Directory of dataset.json')
...
def test(eval_set, save_path, epoch=0):
    ...
    with torch.no_grad():
        ...
        for iteration, (input, indices) in tqdm(enumerate(test_data_loader, 1), 
