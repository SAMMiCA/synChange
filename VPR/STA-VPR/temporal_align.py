...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--name', help="get file path and name of distance matrix")
    args = parser.parse_args()

    startID=int(args.startid)  #start ID of query sequence
    l = int(args.length)  # length of query sequence
    fname = args.name  # file path+name of distance matrix between all query images and historical reference images
