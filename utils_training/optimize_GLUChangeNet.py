...
from utils_training.multiscale_loss import multiscaleEPE, realEPE, sparse_max_pool, multiscaleCE
...
def train_epoch(net,
    ...
    for i, mini_batch in pbar:
        ...
        train_writer.add_scalar('train_flow_per_iter', Loss_flow.item(), n_iter)
        train_writer.add_scalar('train_change_per_iter', Loss_change.item(), n_iter)
        train_writer.add_scalar('train_total_per_iter', Loss_total.item(), n_iter)
